var finances = [
    ...
    // Printing text as seen in desired command prompt
    ...
    for (i = 1; i < finances.length; i++){
        // Substracting current month from upcoming
        mChange = finances[i][1] - finances[i-1][1];
        // Adding changes 
        totalChange = (totalChange + mChange) 
    }
        // Dividing the total changes by total number of months
    let averageChange = totalChange / (totalMonths - 1);
    console.log(`Average Change: ${averageChange.toFixed(2)}`)
    // Finding highest & lowest profit as well as determining whether month a is greater than month b
